...
| **Expander** | LLM-driven graph growth — discovers related moments, renders each through Flash. The expander now includes retry logic for handling malformed LLM JSON responses. |
